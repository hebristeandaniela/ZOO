                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li class="active">
                             ...
                             <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-folder"></i><span>Animals Info</span></a>
                                <ul class="collapse">
                            ...
                            <li>
                                <a href="manage-ticket.php" aria-expanded="true"><i class="ti-layout-sidebar-left"></i><span>Ticket Categories
                                    </span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-folder"></i><span>Indian Ticket</span></a>
                                <ul class="collapse">
                          ...
                          <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="between-dates-normalreports.php">Indian People Report</a></li>
