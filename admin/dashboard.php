...
$count_today_visitors=$result['totaladult'];
 ?>  
                                        <h3 class="header-title mb-0">Today Indian Adult Visitor</h3>
...
$count_today_cvisitors=$result['totalchild'];
 ?>  
                                        <h4 class="header-title mb-0">Today Indian Children Visitor</h4>
...
$count_Yest_visitors=$result['totaladulty'];
 ?>
                                        <h4 class="header-title mb-0">Yesterday Indian Adult Visitor</h4>
...
$count_Yest_cvisitors=$result['totalchildy'];
 ?>
                                        <h4 class="header-title mb-0">Yesterday Indian Child Visitor</h4>
